/* Klasse ImageOwn: Laden und Speichern von Bildern
...
namespace ImageProcessing {
  class ImageOwn {
    ...
    /// 1.1 Instanzen
    /// </summary>
    // Unsichtbare Komponenten zum Laden und Speichern
    ...
    // Sichtbare Komponente aus dem Formular
    ...
    public ImageOwn(form.PictureBox pictureBox) {
    ...
    #region 4. Methoden
    /// <summary> 
    /// 4.1 Konvertiert einen String in das äquivalenten Bildformat.
    /// </summary>
    ...
    /// Picture-Box umrahmt wurde. Entsprechend der Größenverhältnisse
